...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.teacher_id is not None:
            assertions.assert_true(assignment.teacher_id == auth_principal.teacher_id, 'This assignment belongs to another teacher')
    ...
    def get_assignments_by_teacher(cls, teacher_id):
        return cls.filter(cls.teacher_id == teacher_id).filter(cls.state == AssignmentStateEnum.SUBMITTED or cls.state == AssignmentStateEnum.GRADED).all()
